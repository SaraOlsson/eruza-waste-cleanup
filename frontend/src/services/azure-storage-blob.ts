...
const storageAccountName = process.env.storageresourcename || "eruzawastestorage"; // Fill string with your Storage resource name
// </snippet_package>
...
export const readContainerContent = async (): Promise<string[]> => {
